...
public class ListScreenMenuAdapter extends BaseMenuAdapter{
    ...
    public View getTabView(int position, ViewGroup parent) {
        TextView tabView = (TextView) LayoutInflater.from(mContext).inflate(R.layout.data_screen_tab,parent,false);
    ...
    public View getMenuView(int position, ViewGroup parent) {
        ...
        TextView menuView = (TextView) LayoutInflater.from(mContext).inflate(R.layout.data_screen_menu,parent,false);
